...
<body>
	<form action="PremiumCalculator" method="post">
		...
		<br> Manufacturer: <input type="text"
			...
			required="required" value="${vehicle.manufacturer}"><br>
		<br> Vehicle model: <input type="text"
			placeholder="Enter Vehicle model" name="model" required="required"
		...
		<br> Vehicle Cost: <input type="text"
			placeholder="Enter Vehicle Cost" name="cost" required="required"
			value="${vehicle.vehicleCost}"><br>
		<br> Chassis Number: <input type="text"
			placeholder="Enter Chassis Number" name="chassisnumber"
			required="required" value="${vehicle.chassisNo}"><br>
		<br> Vehicle Colour: <input type="text"
			placeholder="Enter Vehicle Colour" name="colour" required="required"
			value="${vehicle.vehicleColour}"><br>
		<br> City: <input type="text" placeholder="Enter City"
			name="city" required="required" value="${vehicle.customer.city}"><br>
		<br>
